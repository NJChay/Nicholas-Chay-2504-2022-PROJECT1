...
function extended_euclid_alg(a::PolynomialSparseBI, b::PolynomialSparseBI, prime::Int)
    old_r, r = mod(a, prime), mod(b, prime)
    old_s, s = one(PolynomialSparseBI), zero(PolynomialSparseBI)
    old_t, t = zero(PolynomialSparseBI), one(PolynomialSparseBI)
...
gcd(a::PolynomialSparseBI, b::PolynomialSparseBI, prime::Int) = extended_euclid_alg(a,b,prime) |> first