...
"""
function prod_test_poly_BI(;N::Int = 10^2, N_prods::Int = 20, seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
    ...
    for _ in 1:N
        p_base = PolynomialSparseBI(BTerm(BigInt(1),0))
        for _ in 1:N_prods
    ...
    println("prod_test_poly_BI - PASSED")
end

"""
Test derivative of polynomials (as well as product).
"""
function prod_derivative_test_poly_BI(;N::Int = 10^2,  seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
        p1 = rand(PolynomialSparseBI)
        p2 = rand(PolynomialSparseBI)
    ...
    println("prod_derivative_test_poly_BI - PASSED")
end
...
"""
function division_test_poly_BI(;prime::Int = 101, N::Int = 10^4, seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
        p1 = rand(PolynomialSparseBI)
        p2 = rand(PolynomialSparseBI)
    ...
    println("division_test_poly_BI - PASSED")
end

"""
Test the extended euclid algorithm for polynomials modulo p.
"""
function ext_euclid_test_poly_BI(;prime::Int=101, N::Int = 10^3, seed::Int = 0)
    Random.seed!(seed)
    for _ in 1:N
        p1 = rand(PolynomialSparseBI)
        p2 = rand(PolynomialSparseBI)
    ...
    println("ext_euclid_test_poly_BI - PASSED")
end